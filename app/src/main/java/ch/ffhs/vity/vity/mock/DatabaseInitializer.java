...
public class DatabaseInitializer {
    ...
    private static VityItem addItem(final AppDatabase db, final String owner, final String title, final String description, final String category, final String link) {
